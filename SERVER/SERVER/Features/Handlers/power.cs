...
namespace SERVER.Features.Handlers
{
    static class power
    {
        public static string Apply(object[] parameters)
        {
            ...
            string criteria = parameters[3].ToString();
            ...
            affected.AffectedActor.power += value;
            string buffer = affected.AffectedActor.Pseudo + ":" + value + ":" + affected.AffectedActor.power + ":power";
